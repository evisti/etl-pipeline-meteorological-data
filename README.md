...
Use Python to assemble data into a Pandas dataframe and store into a PostgreSQL database. 
...
Description of parameters: https://www.dmi.dk/friedata/dokumentation/meteorological-observations-data
